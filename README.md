...
```bash
git clone https://github.com/SimonHeistermann/Quizly-Render.git
cd Quizly-Render
cd backend
```
...
├── backend/
│   ├── apps/
│   │   ├── user_auth_app/            # Auth (JWT cookies), registration/login/logout
│   │   └── quiz_management_app/      # Quiz CRUD + generation pipeline
...
│
├── frontend/
│   ├── pages/                        # HTML pages (views)
│   ├── shared/                       # Shared CSS + JavaScript modules
